            ...
            <div class="form">
                <form action="proses/login.php" method="POST">
                  <div class="form-group">
                      <label for="exampleInputEmail1" class="text-second">username</label>
                      <input type="text" class="form-control text-second" id="exampleInputEmail1" placeholder="Username" name="username" style="width: 500px;">
                  </div>
                  <br>
                  <div class="form-group">
                      <label for="exampleInputEmail1" class="text-second">Password</label>
                      <input type="password" class="form-control text-second" id="exampleInputEmail1" placeholder="Password" name="pass" style="width: 500px;">
                  </div>
                  <br>
